package com.framework.myandroidroot.net;
...
public class RetrofitManager {
     ...
     * 日志拦截器
     */
    private static final HttpLoggingInterceptor mLoggingInterceptor = new HttpLoggingInterceptor(new MyHttpLogging())
...
//                            .cookieJar(cookieJar)
    ...
    public static <T> T create_1(Class<T> clazz) {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(Constant.PART_BASE_URL)
